...
public abstract class BaseFinder<T> {
    ...
    public BaseFinder(EntityManagerFactory entityManagerFactory) {
        this.entityManagerFactory = entityManagerFactory;
    }

    public T executeNative(final String sql, final Map<String, Object> params) {
    ...
    public T find(final Class<T> c, long id) {
        EntityManager entityManager = getEntityManager();
        T result = null;
    ...
    public T find(final Class<T> c, String key, Object value) {
        EntityManager entityManager = getEntityManager();
        T result = null;
    ...
    public List<T> all(final Class<T> c) {
        EntityManager entityManager = getEntityManager();
        List<T> results;
    ...
    public List<T> query(final Class<T> c, String key, Object value) {
        EntityManager entityManager = getEntityManager();
        List<T> results = null;
