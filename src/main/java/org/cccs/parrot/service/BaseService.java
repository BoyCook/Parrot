...
//        validate(entity);
    ...
    private void handleException(final T entity, final RuntimeException e) {
        logError(entity, e);
...
//        }
    ...
    private void logError(final T entity, final Exception e) {
        final String msg = format(ERROR_MESSAGE, entity.getClass().getSimpleName(), entity.toString());
        log.error(msg, e);
        log.error(e.getMessage());
    }

    protected abstract void checkForExisting(final T entity);
}
